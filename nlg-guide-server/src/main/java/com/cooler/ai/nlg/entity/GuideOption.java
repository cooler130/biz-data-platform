...
public class GuideOption {
    ...
    public GuideOption(Integer id, Integer nlgId, Byte optionNum, String optionSentence, String optionExtInfo, String domainName, String taskName, String intentName, String slotKvs, Byte enable, String msg) {
        this.id = id;
        this.nlgId = nlgId;
