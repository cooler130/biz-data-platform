package com.cooler.biz.auth.service.impl;
...
public class TokenServiceImpl implements TokenService {
    ...
    public String generate(Object subject, Map<String, Object> payload, int hours) {
        String token = buildToken(subject, payload, hours);
        return token;
    }
    ...
    public Jws<Claims> parse(Object subject, String token) {
        try {
            ...
            JwtParser jwtParser = parser.requireSubject(subject.toString()).setSigningKey(secret);
