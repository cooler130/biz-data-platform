package com.cooler.biz.base.handler;
...
public class ExceptionsHandler {
    ...
    public Result exception(Exception e) {
        ...
        return new Result().fail(500, "Error");
    }
    ...
    public Result notFoundException() {
        return new Result().fail(404, "Not found");
    }
    ...
    public Result httpRequestMethodNotSupportedException() {
        return new Result().fail(405, "Method not allowed");
    }
    ...
    public Result parameterException() {
        return new Result().fail(403, "Parameter error");
    }
    ...
    public Result maxUploadSizeExceededException() {
        return new Result().fail(403, "File is too large");
    }
    ...
    public Result serviceException(ServiceException e) {
        return new Result().fail(e.getCode(), e.getMessage(), e.getData());
    }
